...
enum ColorUtils {
    ...
    static func argbFrom(x: Double, y: Double, z: Double) -> Int {
    ...
    static func xyzFrom(argb: Int) -> [Double] {
    ...
    /// Integer.
    static func argbFrom(l: Double, a: Double, b: Double) -> Int {
    ...
    static func labFrom(argb: Int) -> [Double] {
        let whitePoInt = whitePointD65()
    ...
    static func argbFrom(lstar: Double) -> Int {
    ...
    static func lstarFrom(argb: Int) -> Double {
    ...
    static func yFrom(lstar: Double) -> Double {
        let ke = 8.0
        if (lstar > ke) {
    ...
    static func linearized(rgbComponent: Int) -> Double {
